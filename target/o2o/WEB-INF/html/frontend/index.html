...
<div class="page-group">
    ...
    <div class="panel panel-right panel-reveal" id="panel-right-demo">
        <div class="content-block">
            <p>
                <a href="/local/accountbind?usertype=1" class="close-panel">绑定帐号</a>
            </p>
            <p>
                <a href="/local/changepsw?usertype=1" class="close-panel">修改密码</a>
            </p>
            <p>
            ...
            <p>
                <a href="/frontend/pointrecord" class="close-panel">兑换记录</a>
            </p>
            <p>
